...
class MinesweeperAI():
    ...
    def stringify_knowledge(self):
        return [str(sentence) for sentence in self.knowledge]
    ...
    def add_knowledge(self, cell, count):
        ...
        while True:
            ...
            if self.knowledge == previous_knowledge and self.mines == previous_mines and self.safes == previous_safes:
                break
    ...
    def make_safe_move(self):
        ...
        print(f"Knowledge base: {self.stringify_knowledge()}")
